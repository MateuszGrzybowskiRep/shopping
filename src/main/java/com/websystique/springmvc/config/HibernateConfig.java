...
public class HibernateConfig {
    ...
    private final static String DATABASE_URL = "jdbc:mysql://localhost:3306/Sklep";
    private final static String DATABASE_DRIVER = "com.mysql.jdbc.Driver";
    private final static String DATABASE_DIALECT = "org.hibernate.dialect.MySQL5Dialect";
    private final static String DATABASE_USERNAME = "klient";
    private final static String DATABASE_PASSWORD = "Z7x6ernc!";
